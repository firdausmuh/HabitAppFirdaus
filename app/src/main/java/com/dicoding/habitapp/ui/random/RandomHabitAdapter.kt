...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvTitle: TextView = itemView.findViewById(R.id.tv_title_pager)
        private val tvStartTime: TextView = itemView.findViewById(R.id.tv_start_time_pager)
        private val tvMinutes: TextView = itemView.findViewById(R.id.tv_minutes_pager)
        private val ivPriority: ImageView = itemView.findViewById(R.id.iv_priority_level)
